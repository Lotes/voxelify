...
class Voxelifier {
  ...
  compute() {
    ...
    const unitSieve = new UnitSieve(new THREE.Box3(new THREE.Vector3(0, 0, 0), new THREE.Vector3(maxAllowedSize, maxAllowedSize, maxAllowedSize)))
    MeshExtensions.getFaces(subject)
      ...
      .subscribe(faceItem => {
          ...
          colorGrid.add(coords.x, coords.y, coords.z, color)
      })
    return colorGrid
  }
}
