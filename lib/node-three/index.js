const threeServer = require('./three-server')
threeServer.loadInternalModule('examples/js/loaders/MTLLoader.js')
threeServer.loadInternalModule('examples/js/renderers/Projector.js')
threeServer.loadInternalModule('examples/js/renderers/CanvasRenderer.js')
threeServer.loadLocalModule('OBJMTLLoader.js')
const THREE = threeServer.THREE
...
function awaitLoadingManager(result) {
