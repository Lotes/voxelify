...
let threePath = getInstalledPath('three', true)
console.log(`1. threePath: '${threePath}' - '${typeof threePath}'`)
if (threePath === null || threePath === '') {
  threePath = getInstalledPath('three', false)
  console.log(`2. threePath: '${threePath}' - '${typeof threePath}'`)
}
