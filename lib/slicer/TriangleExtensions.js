...
* @returns {Generator<THREE.Vector2>} returns all pixel coordinates of the texture within the triangle
*/
...
* @returns {Generator<THREE.Vector2>} a set of integer points within thhis triangle
*/
